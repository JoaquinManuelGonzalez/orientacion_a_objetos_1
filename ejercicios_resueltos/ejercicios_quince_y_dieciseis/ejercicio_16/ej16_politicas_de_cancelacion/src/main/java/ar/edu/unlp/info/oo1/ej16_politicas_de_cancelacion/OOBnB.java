...
public class OOBnB {
	...
	public Propiedad registrarPropiedad (String nombre,
		...
		Propiedad nuevaPropiedad = propietario.crearReserva(nombre, descripcion, direccion, precioPorNoche, politicaDeCancelacion);
	...
	public double calcularMontoAReembolsar (Reserva reserva, LocalDate fechaTentativa) {
		return reserva.getPropiedadReservada().calcularMontoAReembolsar(reserva, fechaTentativa);
	}
